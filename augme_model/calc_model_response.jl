...
ARGS:
p:               external force
u0:              initial conditions  [x0, v0, fr0, ε0]
θ:               model parameters
t:               evaluation times
...
function calc_model_response(p, u0, θ, t, integration_alg=RK4(),
    ...
    # assign the initial condition of the latent variable
    u0_aug  = [u0; θ[1]]    # initial conditions: [x0  v0  fr0  ε0  s0]
    θ_model = θ[2:end]      # model parameter

    # define and solve the ODE problem
    problem        = ODEProblem(aux_model, u0_aug, tspan, θ_model)
